  ...
  return (
    <div className="max-w-md mx-auto p-4">
      ...
      <form>
        ...
        <button type="submit" className="mt-8 block w-full bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600" onClick={handelSubmit}>Submit OTP</button>
      </form>
    </div>
  );
};
